...
Call log:
  - waiting for locator('#appointment-cancel-action-66843').or(getByRole('button', { name: /Cancel the appointment|Cancelar cita/i })).or(locator('button, li').filter({ hasText: /Cancel the appointment|Cancelar cita/i })).first() to be visible
                      ...
                      - row [ref=f5e208] [cursor=pointer]:
                        ...
                        - cell [ref=f5e217]:
                          - generic [ref=f5e218]:
                            - generic [ref=f5e219]: 
                            - generic [ref=f5e222]:
                              - generic [ref=f5e223]: 15/09/2026
                              - generic [ref=f5e224]: 10:00
                            - generic [ref=f5e225]: 
                        - cell [ref=f5e228]: "66843"
                        - cell [ref=f5e229]
                        - cell [ref=f5e230]: 11121112668432026c1d6b
                        - cell [ref=f5e231]:

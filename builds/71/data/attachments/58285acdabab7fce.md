...
Call log:
  - waiting for locator('#default-page-button, .MuiFab-root, button[aria-label*="Add" i]').or(getByRole('button', { name: /Add|Añadir/i })).first() to be visible
          ...
          - generic [ref=e128]:
            - generic [ref=e132]:
              - button "Icon Button" [ref=e134] [cursor=pointer]:
                - generic [ref=e135]: 
              - textbox "Search for procedures" [active] [ref=e137]: Automation Procedure 583062

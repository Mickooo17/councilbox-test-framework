...
- Name: tests/users/usersTests.spec.ts >> Users - Add User Tests >> The admin is able to choose entities when adding the user - Add user form @XR-1619 @regression
- Location: tests/users/usersTests.spec.ts:87:7

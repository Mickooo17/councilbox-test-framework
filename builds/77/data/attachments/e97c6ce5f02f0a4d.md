...
Call log:
  - Expect "toBeVisible" getByText(/^Appointment$/i).or(getByRole('heading', { name: /Appointment/i })).first() with timeout 15000ms
  - waiting for getByText(/^Appointment$/i).or(getByRole('heading', { name: /Appointment/i })).first()
  - Test timeout of 30000ms exceeded.
...
- dialog:
  ...
  - paragraph: Status
  - paragraph: Canceled
  - paragraph: Modified by
  - paragraph: Ammar Mičijević (Agent with video attention)
  - paragraph: Date
  - paragraph: September 24, 2026 11:22 AM
  - paragraph: Reason
  - paragraph: Unavailability
  - paragraph: Observations
  - paragraph: Canceled via automated test for XR-3126 verification
  - paragraph: CONSENTS
  - paragraph: Consent
  - text: 
  - paragraph: Pending
  - paragraph: Ammar Micijevic
  - paragraph: SIGNATURES
  - paragraph: Signature Signature Signature Signature Signature Signature Signature Signature Signature Signature Signature Signature
  - text: 
  - paragraph: Pending
  - paragraph: Ammar Micijevic
  - paragraph: signature of a professional is required
  - text: 
  - paragraph: Pending
  - paragraph: Ammar Micijevic
```

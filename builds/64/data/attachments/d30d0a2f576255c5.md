...
Call log:
  - waiting for locator('tr').filter({ hasText: '66839' }).first() to be visible
  ...
  - generic [ref=f7e4]:
    ...
    - generic [ref=f7e11]:
      - link [ref=f7e13] [cursor=pointer]:
        ...
        - button " Activity" [ref=f7e14]:
          - generic [ref=f7e15]: 
          - generic [ref=f7e17]: Activity
      - link [ref=f7e19] [cursor=pointer]:
        - /url: /company/2419
        - button " Appointments" [ref=f7e20]:
          - generic [ref=f7e21]: 
          - generic [ref=f7e23]: Appointments
      - link [ref=f7e25] [cursor=pointer]:
        - /url: /company/2419/managements
        - button " Processes" [ref=f7e26]:
          - generic [ref=f7e27]: 
          - generic [ref=f7e29]: Processes
      - link [ref=f7e31] [cursor=pointer]:
        - /url: /company/2419/procedures
        - button " Procedures" [ref=f7e32]:
          - generic [ref=f7e33]: 
          - generic [ref=f7e35]: Procedures
      - link [ref=f7e37] [cursor=pointer]:
        - /url: /company/2419/drafts
        - button " Templates" [ref=f7e38]:
          - generic [ref=f7e39]: 
          - generic [ref=f7e41]: Templates
      - link [ref=f7e43] [cursor=pointer]:
        - /url: /company/2419/documentation
        - button " Documents" [ref=f7e44]:
          - generic [ref=f7e45]: 
          - generic [ref=f7e47]: Documents
      - link [ref=f7e49] [cursor=pointer]:
        - /url: /company/2419/companies
        - button " Entities" [ref=f7e50]:
          - generic [ref=f7e51]: 
          - generic [ref=f7e53]: Entities
      - link [ref=f7e55] [cursor=pointer]:
        - /url: /company/2419/users
        - button " Users" [ref=f7e56]:
          - generic [ref=f7e57]: 
          - generic [ref=f7e59]: Users
    - generic [ref=f7e61]:
      - img "CBX white Logo" [ref=f7e62]
      - generic [ref=f7e63]: © 2026 v8.6.6
  - generic [ref=f7e65]:
    - banner [ref=f7e66]:
      - generic [ref=f7e68] [cursor=pointer]:
        - generic [ref=f7e69]: 
        - paragraph [ref=f7e72]: Automation Institution 847281
      - generic [ref=f7e73]: Automation Institution 847281
      - generic [ref=f7e79]:
        - button "" [ref=f7e83] [cursor=pointer]
        - button "Actions Button" [ref=f7e89] [cursor=pointer]:
          - generic [ref=f7e92]:
            - img "logo" [ref=f7e94]
            - generic [ref=f7e95]: 
    - generic [ref=f7e97]:
      - button "Actions Button" [ref=f7e100] [cursor=pointer]:
        - generic [ref=f7e101]: 
      - generic [ref=f7e104]:
        - generic [ref=f7e108]:
          - button "Icon Button" [ref=f7e109] [cursor=pointer]:
            - paragraph [ref=f7e111]: Video-appointments
          - button "Icon Button" [ref=f7e113] [cursor=pointer]:
            - paragraph [ref=f7e115]: In-person appointments
        - generic [ref=f7e118]:
          - generic [ref=f7e120]:
            - generic [ref=f7e121]:
              - generic [ref=f7e123]:
                - generic [ref=f7e126]:
                  - generic [ref=f7e127] [cursor=pointer]:
                    - generic [ref=f7e129]:
                      - generic [ref=f7e130]: 
                      - generic [ref=f7e131]: List view
                    - textbox "Input":
                      - /placeholder: ""
                      - text: "[object Object]"
                  - group "Input fieldset"
                - generic [ref=f7e135]:
                  - generic [ref=f7e136]: Status
                  - generic [ref=f7e137]:
                    - button "Confirmed, In progress, Pending report, Completed, In pause" [ref=f7e138] [cursor=pointer]
                    - textbox [aria-hidden]: confirmed,room_opened,act_pending,complete,paused
                - generic [ref=f7e140]:
                  - generic [ref=f7e141]: Period
                  - generic [ref=f7e142]:
                    - button "This week" [ref=f7e143] [cursor=pointer]
                    - textbox [aria-hidden]: week
                - button "Icon Button" [ref=f7e145] [cursor=pointer]:
                  - generic [ref=f7e146]: 
              - generic [ref=f7e148]:
                - generic [ref=f7e149]:
                  - paragraph [ref=f7e150]: Search by participant or record
                  - generic [ref=f7e153]:
                    - button "Icon Button" [ref=f7e155] [cursor=pointer]:
                      - generic [ref=f7e156]: 
                    - textbox "Search" [active] [ref=f7e158]: "66839"
                - button "Icon Button" [ref=f7e159] [cursor=pointer]:
                  - generic [ref=f7e160]: 
            - generic [ref=f7e163]:
              - generic [ref=f7e165]:
                - img "logo" [ref=f7e167]
                - generic [ref=f7e168]: No appointments available for the selected period and states.
              - generic [ref=f7e170]:
                - paragraph [ref=f7e171] [cursor=pointer]: Legal notice and Terms and conditions of use
                - paragraph [ref=f7e172] [cursor=pointer]: PRIVACY_POLICY
          - generic [ref=f7e174]:
            - generic [ref=f7e175] [cursor=pointer]: 
            - generic [ref=f7e177]: 0 selected
```

...
- banner:
  ...
  - button "Actions Button":
    - img "logo"
    - text: 
- text:   Automation Procedure 922852
- button "Icon Button": 
...
- paragraph: Review
- text: Name *
- textbox "Name of the procedure *": Automation Procedure 922852
- text: Type
...
- button:
  - img
- paragraph: Automation Procedure Description C5Sd6kwPjMv9C0Np6YXWN5mxxg28ehYFkaqmWxRN

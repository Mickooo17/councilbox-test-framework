...
Call log:
  - waiting for locator('tr').filter({ hasText: '66909' }).first() to be visible
  ...
  - generic [ref=f6e65]:
    - banner [ref=f6e66]:
      - generic [ref=f6e68] [cursor=pointer]:
        - generic [ref=f6e69]: 
        - paragraph [ref=f6e72]: Automation Institution 266203
      - generic [ref=f6e73]: Automation Institution 266203
      - generic [ref=f6e79]:
        - button "" [ref=f6e83] [cursor=pointer]
        - button "Actions Button" [ref=f6e89] [cursor=pointer]:
          - generic [ref=f6e92]:
            - img "logo" [ref=f6e94]
            - generic [ref=f6e95]: 
    - generic [ref=f6e97]:
      - button "Actions Button" [ref=f6e100] [cursor=pointer]:
        - generic [ref=f6e101]: 
      - generic [ref=f6e104]:
        - generic [ref=f6e108]:
          - button "Icon Button" [ref=f6e109] [cursor=pointer]:
            - paragraph [ref=f6e111]: Video-appointments
          - button "Icon Button" [ref=f6e113] [cursor=pointer]:
            - paragraph [ref=f6e115]: In-person appointments
        - generic [ref=f6e118]:
          - generic [ref=f6e120]:
            - generic [ref=f6e121]:
              - generic [ref=f6e123]:
                - generic [ref=f6e126]:
                  - generic [ref=f6e127] [cursor=pointer]:
                    - generic [ref=f6e129]:
                      - generic [ref=f6e130]: 
                      - generic [ref=f6e131]: List view
                    - textbox "Input":
                      - /placeholder: ""
                      - text: "[object Object]"
                  - group "Input fieldset"
                - generic [ref=f6e135]:
                  - generic [ref=f6e136]: Status
                  - generic [ref=f6e137]:
                    - button "Confirmed, In progress, Pending report, Completed, In pause" [ref=f6e138] [cursor=pointer]
                    - textbox [aria-hidden]: confirmed,room_opened,act_pending,complete,paused
                - generic [ref=f6e140]:
                  - generic [ref=f6e141]: Period
                  - generic [ref=f6e142]:
                    - button "This week" [ref=f6e143] [cursor=pointer]
                    - textbox [aria-hidden]: week
                - button "Icon Button" [ref=f6e145] [cursor=pointer]:
                  - generic [ref=f6e146]: 
              - generic [ref=f6e148]:
                - generic [ref=f6e149]:
                  - paragraph [ref=f6e150]: Search by participant or record
                  - generic [ref=f6e153]:
                    - button "Icon Button" [ref=f6e155] [cursor=pointer]:
                      - generic [ref=f6e156]: 
                    - textbox "Search" [active] [ref=f6e158]: "66909"
                - button "Icon Button" [ref=f6e159] [cursor=pointer]:
                  - generic [ref=f6e160]: 
            - generic [ref=f6e163]:
              - generic [ref=f6e165]:
                - img "logo" [ref=f6e167]
                - generic [ref=f6e168]: No appointments available for the selected period and states.
              - generic [ref=f6e170]:
                - paragraph [ref=f6e171] [cursor=pointer]: Legal notice and Terms and conditions of use
                - paragraph [ref=f6e172] [cursor=pointer]: PRIVACY_POLICY
          - generic [ref=f6e174]:
            - generic [ref=f6e175] [cursor=pointer]: 
            - generic [ref=f6e177]: 0 selected
```

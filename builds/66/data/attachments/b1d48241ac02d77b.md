...
Call log:
  - waiting for locator('#appointment-cancel-action-66860').or(getByRole('button', { name: /Cancel the appointment|Cancelar cita/i })).or(locator('button, li').filter({ hasText: /Cancel the appointment|Cancelar cita/i })).first() to be visible
                      ...
                      - row [ref=f7e208] [cursor=pointer]:
                        ...
                        - cell [ref=f7e217]:
                          - generic [ref=f7e218]:
                            - generic [ref=f7e219]: 
                            - generic [ref=f7e222]:
                              - generic [ref=f7e223]: 16/09/2026
                              - generic [ref=f7e224]: 10:00
                            - generic [ref=f7e225]: 
                        - cell [ref=f7e228]: "66860"
                        - cell [ref=f7e229]
                        - cell [ref=f7e230]: 111211126686020268d515
                        - cell [ref=f7e231]:

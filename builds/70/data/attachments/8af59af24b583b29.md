...
- Name: tests/templates/tagsTests.spec.ts >> Templates - Tags Validation Tests >> should not allow creating tag without code field @XR-1604 @regression
- Location: tests/templates/tagsTests.spec.ts:140:7
...
- generic [ref=e2]:
  ...
  - generic [ref=e211]:
    - generic [ref=e215]:
      - generic [ref=e216]: New version OVAC 8.6
      - generic [ref=e217]:
        - generic [ref=e218]: We have updated the app to the latest version to offer you a better experience. This update includes important improvements, error corrections and optimizations so that use will be easier and friendlier.
        - generic [ref=e219]: Review upgrades

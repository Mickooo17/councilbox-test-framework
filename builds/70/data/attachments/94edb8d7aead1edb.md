...
- Name: tests/users/usersTests.spec.ts >> Users - Add User Tests >> Admin is able to create new user with 'Catala' language in the Users form @XR-626 @regression
- Location: tests/users/usersTests.spec.ts:56:7
